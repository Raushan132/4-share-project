...
inputTypeFile.addEventListener('change', function () {
    if (this.files.length > 0) {
        for (var i = 0; i < this.files.length; i++) {
            ShowFilesList.innerHTML += "<p class='addedFile'><img src='fileIcon/fileIcon.svg' alt='file image'>" + "<span class='fileName'>"+this.files.item(i).name+"</span>" + " <span class='close_button'>✖</span></p>"
        }
    }
